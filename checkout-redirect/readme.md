...
With 4 small changes to the **checkout.liquid** file, those customers will be able to use the full benefits of Flow.

![Checkout Example](https://github.com/flowcommerce/examples-shopify/blob/checkout-redirect/checkout-redirect/checkout-redirect-example.gif?raw=true)


## Additions to Checkout.liquid

**Add Flow.js to Checkout.liquid**

Adding Flow.js to Checkout.liquid will allow Flow to validate shipping availability and redirect customers to Flow Checkout UI. 
...
{% else %}
    {% assign flowUrl = 'https://shopify-cdn.flow.io/fashionnova/js/v0/flow.js?shop=fnova.myshopify.com' %}
{% endif %}
  <script>
    ...
    })(window, document, 'script', '{{flowUrl}}', 'Flow');
  </script>
```
...
Add this HTML content to the page to be show shoppers the option to ship with Flow Internationally.

```html
  <div id="flow-popup" class="popup">
